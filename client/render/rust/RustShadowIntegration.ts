...
export async function initRustRendererShadow(
    ...
    try {
        ...
        // geometry helpers so synchronous actor/ground/model paths can use
        // Rust preparation without introducing async work into the frame loop.
        await Promise.all([
            getVertexBatchBuilderFactory(),
            getModelInfoTextureBuilder(),
            getDrawListBuilder(),
