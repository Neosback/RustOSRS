...
const acceptanceHtml = [
    ...
    "    new Float32Array(), new Int32Array([0,255,11,-1,-1]),",
    ...
    "  // Keep texture/material ID 1 genuinely resident instead of relying on material/layer clamping.",
    "  const rasterVertices = rasterTriangleWords(1);",
    "  // Under identity view/projection the raster fixture is CCW in clip space,",
    ...
    "  renderer.begin_static_frame(acceptanceSky);",
    "  renderer.render_active_static_map_pass(identity(), identity(), identity(), 1, acceptanceSky, acceptanceNoHsl, acceptancePlayerPos, 20, 15, 0, 1, 3, false, false, 1, false);",
    "  assert(renderer.last_draw_calls() === 1 && renderer.last_submitted_indices() === 3, 'water acceptance dry triangle was not submitted');",
    "  renderer.present_frame();",
    "  const dryPixel = readCenter(gl);",
    "  const wetMaterials = new Int8Array(dryMaterials);",
    "  wetMaterials[13] = 1; // material 1, row 1.g = MATERIAL_FLAG_WATER",
    ...
    "  wetMaterials[20] = 255; wetMaterials[21] = 0; wetMaterials[22] = 0; wetMaterials[23] = 255;",
    "  wetMaterials[28] = 0; wetMaterials[29] = 0; wetMaterials[30] = 0; wetMaterials[31] = 0;",
    "  wetMaterials[36] = 0; wetMaterials[37] = 0; wetMaterials[38] = 0; wetMaterials[39] = 0;",
    "  renderer.upload_materials(wetMaterials, 2);",
    ...
    "  assert(dryPixel[0] + dryPixel[1] + dryPixel[2] > 24, 'water acceptance dry triangle did not cover the sampled pixel');",
