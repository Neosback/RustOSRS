...
const acceptanceHtml = [
    ...
    "  ]);",
    "}",
    "function rasterTriangleWords() {",
    "  const hsl = (10 << 10) | (4 << 7) | 80;",
    "  return new Uint32Array([",
    "    ...packVertex(-64, -64, 0, hsl, 255, 7),",
    "    ...packVertex(64, -64, 0, hsl, 255, 7),",
    "    ...packVertex(0, 64, 0, hsl, 255, 7),",
    "  ]);",
    "}",
    ...
    "  wetMaterials[8] = 0; wetMaterials[9] = 255; wetMaterials[10] = 255; wetMaterials[11] = 255;",
    "  wetMaterials[12] = 255; wetMaterials[13] = 32; wetMaterials[14] = 16;",
    "  wetMaterials[17] = 255; wetMaterials[18] = 96;",
    "  renderer.upload_materials(wetMaterials, 1);",
    "  const wetMask = new Uint8Array(4 * 4 * 4);",
    "  for (let i = 0; i < 16; i++) { wetMask[i*4] = 220; wetMask[i*4+1] = 80; wetMask[i*4+2] = 40; wetMask[i*4+3] = 160; }",
